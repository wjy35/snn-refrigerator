...
public class RecipeController {
    ...
    public ResponseEntity<?> getImageUrl(@PathVariable String memberId, @RequestPart(value = "recipeImage",required = false) MultipartFile recipeImage) throws Exception{
        Response response = new Response();
