  ...
  return (
    <View style={{margin: 5}}>
      <TouchableWithoutFeedback onPress={onPressFunction}>
        <View style={[{padding: 5, height: 40,borderRadius: 100, justifyContent: 'space-around', alignItems: 'center', flexDirection: 'row'}, fill?{ backgroundColor: color, }:{borderColor:color, borderWidth:1}]}>
          {leftIcon&&(<SvgXml
              xml={leftIcon}
              width={15}
              height={15}
